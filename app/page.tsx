    ...
    <main className="min-h-screen p-6 md:p-12 max-w-6xl mx-auto">
      <header className="mb-8">
        <h1 className="text-4xl font-bold mb-2">
          Rutgers Dining Hall Menu(Still in Progress some features may not work)
        </h1>
        <p className="text-muted-foreground">
          AI-powered meal planning for healthier dining choices(Still in Progress some features may not work)
        </p>
      </header>
